                ...
                <div class="card shadow-lg bg-gradient bg-dark">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex gap-3 mt-4">
                            <a href="profile.php?do=ads_edit&itemid=<?= $itemid ?>" class="btn btn-secondary w-50 btn-lg fw-bold text-white">Edit Item</a>
                            <a href="profile.php?do=ads" class="btn btn-success w-25 btn-lg fw-bold text-white">Done</a>
                        </div>
                    </div>
                </div>
            </div>
