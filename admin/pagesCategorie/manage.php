...
$stmt = $con->prepare("SELECT * FROM categories ORDER BY ID $sort LIMIT 25");
$stmt->execute();
$rows = $stmt->fetchAll();
?>
<div class="container">
    ...
    <div class="header-section">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
                <h2 class="custom-h2 fw-bold text-start me-2"><i class="fa-solid fa-layer-group"></i> Manage Categories</h2>
            </div>
            <div class="d-flex align-items-center flex-wrap gap-3">
                ...
                <a href="categories.php?do=all_comments" class="btn btn-primary">
                    <i class="fas fa-list me-2"></i>All Category
                </a>
